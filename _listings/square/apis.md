...
created: "2018-06-20"
modified: "2018-06-20"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/items/master/_listings/square/apis.md
...
- name: Square Connect API Provides summary information for all of a location's items.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/items/master/_listings/square/v1location-iditems-get-openapi.md
- name: Square Connect API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/items/master/_listings/square/openapi.md
x-common:
- type: x-base
