...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/items/master/_listings/rebilly/apis.md
specificationVersion: "0.14"
apis:
- name: Rebilly - Retrieve invoice items
  x-api-slug: invoicesiditems-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/items/master/_listings/rebilly/invoicesiditems-get-openapi.md
- name: Rebilly - Create an invoice item
  x-api-slug: invoicesiditems-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/items/master/_listings/rebilly/invoicesiditems-post-openapi.md
- name: Rebilly - Create an invoice item
  x-api-slug: invoicesiditems-post
  description: Create an invoice item
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/rebilly.png
